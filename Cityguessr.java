...
public class Cityguessr extends Generaltrivia {
    ...
    public void runGame(){
        ...
        while (!s.nextLine().equals("q")) {
            ...
            System.out.println("The country that the city originates in is " + list.get(a) + ". The estimated population of the metro area of the city is " + list.get(a + 2) + ".");
            String b = s.nextLine();
            if(b.equals(list.get(a + 1))){
                count++;
